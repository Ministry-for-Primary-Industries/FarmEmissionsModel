...
The example data files we supply (available from our repo README) is consistent with the examples shown in this file. These data files are provided in CSV format.
