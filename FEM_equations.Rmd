...
The majority of stock classes deposit all excretion to pasture. However, mature milking dairy cows deposit 9.4% of excretion in the months they're milking (from "Trends in dairy effluent management (2017) p.25)
...
*Note Organic Fertiliser here is limited to mature milking cow effluent from lagoons spread to pasture. It only applies to mature milking cows and only when milk production is occurring.*
